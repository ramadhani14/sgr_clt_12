...
class CreateMstKehutanan extends Migration
{
    /**
     * Run the migrations.
     *
    ...
    public function up()
    {
        Schema::create('mst_kehutanan', function (Blueprint $table) {
            $table->id();
            $table->date('periode');
            $table->integer('fk_jenis_kehutanan');
    ...
    {
        Schema::dropIfExists('mst_kehutanan');
    }
}
