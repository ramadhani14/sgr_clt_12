...
class CreateMstHortikultura extends Migration
{
    /**
     * Run the migrations.
     *
    ...
    public function up()
    {
        Schema::create('mst_hortikultura', function (Blueprint $table) {
            $table->id();
            $table->date('periode');
            $table->integer('fk_jenis_hortikultura');
    ...
    {
        Schema::dropIfExists('mst_hortikultura');
    }
}
