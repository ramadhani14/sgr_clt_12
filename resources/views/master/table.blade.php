...
<ol class="breadcrumb float-sm-right">
    ...
    <li class="breadcrumb-item active">Table Setting</li>
</ol>
@endsection
            ...
            <div class="modal-body">
              <!-- <div class="card-body"> -->
                <div class="form-group">
                    <label for="judul_{{$key->id}}">Judul Kolom<span class="bintang">*</span></label>
                    <input type="text" class="form-control" id="judul_{{$key->id}}" name="judul[]" placeholder="Judul Kolom" value="{{$key->judul}}">
                </div>  
                <!-- /.form-group -->
              <!-- </div> -->
            </div>
      ...
      <div class="modal-dialog modal-lg">
        <div class="modal-content">
          ...
          <form method="post" id="formHapus_{{$key->id}}" class="form-horizontal">
            @csrf
            <div class="modal-body">
                <h6> Apakah anda ingin menghapus kolom {{$key->judul}}?</h6>
            </div>
            <div class="modal-footer justify-content-between">
                <button type="button" class="btn btn-default" data-dismiss="modal">Batal</button>
      ...
      <div class="modal-content">
        ...
        <form method="post" id="_formData" class="form-horizontal">
          ...
          <div class="modal-body">
              <!-- <div class="card-body"> -->
              <div class="form-group">
                  <label for="judul_add">Judul Kolom<span class="bintang">*</span></label>
                  <input type="text" class="form-control" id="judul_add" name="judul_add" placeholder="Judul Kolom">
              </div>
              <!-- <div class="card-body"> -->
              <!-- /.form-group -->
            <!-- </div> -->
...
<script>
  $(document).ready(function(){
    ...
    $(document).on('click', '.btn-hapus', function (e) {
        ...
        var url = "{{ url('admin/hapustable') }}/"+idform;
        $.ajaxSetup({
            headers: {
    ...
    $(document).on('click', '.btn-submit-data', function (e) {
        ...
        $('#formData_'+idform).validate({
          ...
          messages: {
            'judul[]': {
              required: "Judul kolom tidak boleh kosong"
            }
          },
          errorElement: 'span',
          ...
          submitHandler: function () {
            ...
            var url = "{{ url('admin/updatetable') }}/"+idform;
            $.ajaxSetup({
                headers: {
                    'X-CSRF-TOKEN': $('meta[name="csrf-token"]').attr('content')
                }
