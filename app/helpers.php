...
function tglindocarbon($tgl){
	return Carbon\Carbon::parse($tgl)->translatedFormat('l, d F Y');
}
function tglindocarbonsingkat($tgl){
	return Carbon\Carbon::parse($tgl)->translatedFormat('d M Y');
}
function onlyTahun($tgl){
	return Carbon\Carbon::parse($tgl)->translatedFormat('Y');
}
function onlyBulan($tgl){
	return Carbon\Carbon::parse($tgl)->translatedFormat('-m-d');
}
